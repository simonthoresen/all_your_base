...
import all.things.application.Application;
import all.things.application.ApplicationListener;
...
import all.things.tiled.MazeBuilder;
import all.things.tiled.Tile;
import all.things.tiled.TileSet;
import all.things.tiled.TileSheet;
import all.things.tiled.TileSheetRenderer;
import all.things.tiled.math.Board;
import all.things.tiled.math.Light;
import all.things.tiled.math.LightMap;
import all.things.tiled.math.Rectangle;
    ...
    public void update(ApplicationManager appManager, long currentTimeNanos, long deltaTimeNanos) {
        if (lightMap == null) {
            lightMap = LightMap.newInstance(board, new Rectangle(playerPos.x - renderTileCols / 2,
                                            ...
                                            new all.things.tiled.math.Point(playerPos.x, playerPos.y));
        }
    }
